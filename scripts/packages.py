toolchains = {
    'gcc-arm-none-eabi': {
        'gcc-arm-none-eabi_5_3-2016q1-20160330': {
            'linux': {
        ...
        'gcc-arm-none-eabi-7-2018-q2-update': {
            'linux': {
                'filename': 'gcc-arm-none-eabi-7-2018-q2-update-linux.tar.bz2',
                'download size': '0',
                'installation size': '0',
                'version': '7.3.0',
            ...
            'windows': {
                ...
                'installation size': '0',
                'version': '7.3.0',
                'url': 'https://developer.arm.com/-/media/Files/downloads/gnu-rm/7-2018q2/gcc-arm-none-eabi-7-2018-q2-update-win32.zip?revision=9b83e69c-e279-4d16-9401-990c836197b3?product=GNU%20Arm%20Embedded%20Toolchain,ZIP,,Windows,7-2018-q2-update',
                'checksum': {'md5': ' bc8ae26d7c429f30d583a605a4bcf9bc'},
                'licenseUrl': 'https://developer.arm.com/GetEula?Id=7f7f1581-ce37-49ab-972f-c4163729fa47',
                'installationLocation': '{app}\\toolchains\\gcc-arm-none-eabi\\microhal'
            }
        },
    ...
    'mingw': {
        ...
        '8.1.0': {
            'linux': {},
            'windows': {
                'filename': 'x86_64-8.1.0-release-posix-seh-rt_v6-rev0.7z',
                'download size': '0',
                'installation size': '0',
                'version': '8.1.0',
                ...
                'checksum': {'md5': '55c00ca779471df6faf1c9320e49b5a9'},
                'licenseUrl': 'http://sourceforge.net/projects/mingw-w64/',
                'installationLocation': '{app}\\toolchains\\mingw-w64'
            }
        }
...
doxygen = {
    ...
    '1.8.14': {
        'linux': {},
        'windows': {
            'filename': 'doxygen-1.8.14.windows.x64.bin.zip',
            'download size': '0',
            'installation size': '0',
            'version': '1.8.14',
            'url': 'http://ftp.stack.nl/pub/users/dimitri/doxygen-1.8.14.windows.x64.bin.zip',
            'checksum': {'': ''},
            'licenseUrl': 'http://www.stack.nl/~dimitri/doxygen/index.html',
...
cppcheck = {
    ...
    '1.84': {
        'linux': {},
        'windows': {
            'filename': 'cppcheck-1.84-x64-Setup.msi',
            'download size': '0',
            'installation size': '0',
            'version': '1.84',
...
graphviz = {
    '2.38': {
        ...
        'windows': {
            ...
            'checksum': {'': ''},
            'licenseUrl': '',
            'installationLocation': '{app}\\tools\\graphviz\\2.38'}
    }
}
...
msys = {
    '13': {
        'windows': {
            ...
            'checksum': {'md5': '4c79f989eb6353a0d81bc39b6f7176ea'},
            'licenseUrl': '',
            'installationLocation': '{app}\\tools\\msys'
        }
    }
}
