toolchains = {
    'gcc-arm-none-eabi': {
        ...
        'gcc-arm-none-eabi-7-2018-q2-update': {
            ...
            'windows': {
                'filename': 'gcc-arm-none-eabi-7-2018-q2-update-win32-sha2.exe',
                'size': '0',
                'version': '7.3.0',
                'url': 'https://developer.arm.com/-/media/Files/downloads/gnu-rm/7-2018q2/gcc-arm-none-eabi-7-2018-q2-update-win32-sha2.exe?revision=bc72768f-9927-454e-9141-918927fb74ff?product=GNU%20Arm%20Embedded%20Toolchain,32-bit,,Windows,7-2018-q2-update',
                'checksum': {'md5': 'f94f652fec26efa90874d7f40cf2ca6c'},
                'licenseUrl': 'https://developer.arm.com/GetEula?Id=7f7f1581-ce37-49ab-972f-c4163729fa47',
                'installationLocation': 'microideDir/toolchains/gcc-arm-none-eabi/microhal'
            }
        }
